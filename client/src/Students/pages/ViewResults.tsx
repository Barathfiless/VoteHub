...
const ViewResults = () => {
  ...
  return (
    <div className="container mx-auto py-8 max-w-4xl">
      ...
      <Card className="mb-8 border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 overflow-hidden">
        {election.logo_url && (
        ...
        <CardHeader>
          <CardTitle className="text-2xl text-gray-900 dark:text-white">{election.title} - Results</CardTitle>
        ...
        <CardContent>
          <div className="grid gap-6 md:grid-cols-4 text-sm">
            <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
              ...
              <p className="font-bold text-base text-gray-900 dark:text-white mt-1">{election.department}</p>
            </div>
            <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
              <p className="text-gray-600 dark:text-gray-400 font-semibold">Position</p>
              <p className="font-bold text-base text-gray-900 dark:text-white mt-1">{election.standing_post}</p>
            </div>
            <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
              <p className="text-blue-600 dark:text-blue-400 font-semibold">Total Votes</p>
              <p className="font-bold text-xl text-blue-900 dark:text-blue-300 mt-1">{totalVotes}</p>
            </div>
            <div className="bg-emerald-50 dark:bg-emerald-900/20 p-4 rounded-lg border border-emerald-200 dark:border-emerald-800">
              <p className="text-emerald-600 dark:text-emerald-400 font-semibold">Candidates</p>
              <p className="font-bold text-xl text-emerald-900 dark:text-emerald-300 mt-1">{election.candidates?.length || 0}</p>
            </div>
          </div>
        </CardContent>
      </Card>
